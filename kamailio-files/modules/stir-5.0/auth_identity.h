...
#include "../../core/parser/parse_identity_stir.h"
...
#define AUTH_MSG_VALIDITY_TIME 60
#define AUTH_MSG_TO_AUTH_VALIDITY_TIME 60
...
int assemble_passport(dynstr *sout, struct sip_msg *msg, time_t t, char *x5u_URI, EC_KEY *eckey);
