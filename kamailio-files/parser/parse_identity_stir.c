 ...
 */
static int movetomybuffer (char *pstart,
					char *pend,
					char *pcur,
					struct identity_body_stir *ib)
{
	char *phashend;
...
void parse_identity_stir(char *buffer, char* end, struct identity_body_stir* ib)
{
...
{
	struct identity_body_stir* identity_b;
